        ...
        () {
          {
            return RefreshIndicator(
              onRefresh: () => controller.fetchTransaction(false),
              child: ListView(
                children: [
                  Padding(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        ...
                        controller.filterTransactionByStatus();
                      },
                  ...
                  controller.isLoading.value
                      ...
                      : controller.transaction.isEmpty
                          ? Center(
                                ...
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    if (transaction.transactionItems != null) {
                                      for (var product
                                          in transaction.transactionItems!) {
                                        ModelProduct data = await ModelProduct
                                            .fetchDetailsRecords(
