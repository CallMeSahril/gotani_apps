                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(Formatter.formatToRupiah(
                    ...
                    onPressed: () async {
                      ...
                      if (controller.cartItems
                        ...
                        return;
                              ...
                              .length >
                          1) {
                        Get.snackbar("Warning", "Pilih maxsimal 1 keranjang");
                        return;
                      } else if (controller.address.value.address == null) {
                        Get.snackbar("Warning", "Pilih Alamat");
                        return;
                      } else if (controller.deliveryType.value.service ==
                          null) {
                        ...
                        var idCart = await controller.cartItems
                        ...
                        if (body['status'] == "success" &&
                          ...
                          if (body['data']['payment_url'] != null) {
                            ...
                            final responseDelete = await http.delete(
                              Uri.parse("$mainUrl/cart-items/${idCart}"),
                              headers: {
                                HttpHeaders.authorizationHeader:
                                    "Bearer $token",
                              },
                            ...
                            var bodyDelete = jsonDecode(responseDelete.body);
                            if (bodyDelete['status'] == "success") {
                              controller.fetchCart();
                            } else {}
